...
class KeycloakServiceTest {
    ...
    private final String REALM = "bank";
    ...
    @Test
    @DisplayName("Список всех roles конкретного realm из Keycloak")
    void listKeycloakRolesTest() {
    ...
    @Test
    @DisplayName("Список всех users конкретного realm из Keycloak")
    void listKeycloakUsersTest() {
